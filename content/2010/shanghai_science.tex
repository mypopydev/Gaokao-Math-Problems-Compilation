...
要使交点为不同的两个点，须且只须 \(F\) 在椭圆内部，即 \(\frac{x_F^2}{a^2}+\frac{y_F^2}{b^2}<1\). 代入 \(F\) 的坐标，得 \(\frac{(1-\cos\theta)^2+(1+\sin\theta)^2}{4}<1\)，即 \(\sin\theta-\cos\theta<1\). 于是 \(\sqrt{2}\sin\left(\theta-\frac{\pi}{4}\right)<1\). 结合 \(0<\theta<\pi\)，可得 \(0<\theta<\pi\)，且排除 \(\theta=\frac{\pi}{2}\) 时的退化边界.
\end{enumerate}
\end{solution}
